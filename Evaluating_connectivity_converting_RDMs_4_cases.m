...
for subject=1:Num_subjects
    ...
    for numb=1:3
        for time=1:max(samples_sizes)
            ...
            elseif numb==2
                ...
                RDM_source_t(:,time,numb)=X_identities(~isnan(X_identities))+randn(Num_unq_RDM_cells,1);
    ...
    [subject case_number]
    save(['Evaluating_connectivity_converting_RDMs_4_cases.mat'],'MVGC','FFs_E','FBs_E','FFs_iter_E','FBs_iter_E','FFs_H','FBs_H','FFs_iter_H','FBs_iter_H','Corr_to_Model')
end
ccc
...
load(['Evaluating_connectivity_converting_RDMs_4_cases.mat'],'MVGC','FFs_E','FBs_E','FFs_iter_E','FBs_iter_E','FFs_H','FBs_H','FFs_iter_H','FBs_iter_H','Corr_to_Model');
