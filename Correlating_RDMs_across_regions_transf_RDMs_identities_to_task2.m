...
direction=2; % 1= (1=>2) FF; 2= (2=>1) FB; 
  
    
repititions=100;
for repitition=1:repititions
    
    A=randn(10,16,500); % channel_in_region * condition_in_region * time sample
...
%     close all;
    [repitition]
    save('Connectivity_repititions_corrected_FB_only_MVGC.mat','MVGC')
end
...
% load('Connectivity_repititions_corrected2_FB_only_Hamid.mat')
% 
% FFs2_H=FFs_H(:,1:50);
% FBs2_H=FBs_H(:,1:50);
...
% 
% 
% load('Connectivity_repititions_corrected_FB_only_Hamid.mat')
% 
% 
% FFs_H(:,1:50)=FFs2_H;
% FBs_H(:,1:50)=FBs2_H;
...
% 
% figure;
% shadedErrorBar([1:size(FFs_H,1)],nanmean(FFs'),nanstd(FFs')./sqrt(repititions),{'color',[0.1 0.1 0.8],'LineWidth',2},1)
% hold on;
% shadedErrorBar([1:size(FFs_H,1)],nanmean(FBs'),nanstd(FBs')./sqrt(repititions),{'color',[0.8 0.1 0.1],'LineWidth',2},1)
% shadedErrorBar([1:size(FFs_H,1)],nanmean(FFs')-nanmean(FBs'),(nanmean(FFs')-nanmean(FBs'))./sqrt(repititions),{'color',[0.1 0.8 0.1],'LineWidth',2},1)
% 
