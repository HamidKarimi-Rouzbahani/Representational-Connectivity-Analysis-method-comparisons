...
for subject=1:Num_subjects
    ...
    for numb=1:3
        for time=1:max(samples_sizes)
            ...
            elseif numb==3
                ...
                desired_task={'A','A','I','I','A','A','I','I','A','A','I','I','A','A','I','I'};
    ...
    ccc
    [subject case_number]
    save(['Evaluating_connectivity_converting_RDMs_4_cases_opposing.mat'],'MVGC','FFs_E','FBs_E','FFs_iter_E','FBs_iter_E','FFs_H','FBs_H','FFs_iter_H','FBs_iter_H','Corr_to_Model')
end
...
load(['Evaluating_connectivity_converting_RDMs_4_cases_opposing.mat'],'MVGC','FFs_E','FBs_E','FFs_iter_E','FBs_iter_E','FFs_H','FBs_H','FFs_iter_H','FBs_iter_H','Corr_to_Model');


method=3; % 1= Erin; 2=Hamid; 3=Alex
case_number=4; %% 1= Semantics both regions, 2=Negating-semantics both regions, 3= frontal Semantics and occipital negating-semantics, 4= opposite to 3
...
if method<3
    ...
    figure;
    models={'Semantics','Negating-semantics','Semantics','Negating-semantics'};
...
legend([Diffr{1}.mainLine Diffr{2}.mainLine Diffr{3}.mainLine Diffr{4}.mainLine],{'Semantics across regions','Negated-semantics across regions','Semantics FF and Negated-semantics FB','Negated-semantics FF and Semantics FB'})
set(gca,'fontsize', 18);
